                    ...
                    <li class="my-4 postBlockOld" id="postBlock_{{ $index }}">
                        <div class="form-group mb-3 row">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control border border-secondary rounded-0" id="description_{{ $index }}" rows="14" placeholder="Описание" disabled>{{ !empty($post)? $post->description : '' }}</textarea>
                                </div>
                            </div>
                            @if($post->photo)
                                <div class="mb-3">
        ...
        $("#editPageForm").submit(function(event){
            ...
            $(".postBlock").each(function(i, ell){
                ...
                if($(this).find(".post")[0].files[0] !== 'undefined'){
                    formData.append("post_" + i, $(this).find(".post")[0].files[0]);
                }
            });
