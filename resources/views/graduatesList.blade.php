        ...
        <div class="mt-5 dbList">
            ...
            <table class="table table-hover">
                <thead>
                    ...
                    <tr>
                        <form method="GET" action="{{route('graduates_list', [ 'site' => env('DB_SITE')])}}">
                ...
                <tbody id="graduatesTable">
                    @foreach($graduates as $graduate)
                        <tr class="recordRow" row-record-id="{{ $graduate->id }}">
                            ...
                            <td><button class="form-control btn btn-primary" viewRecord record-id="{{ $graduate->id }}"><i class="bi bi-pencil-square"></i></button></td>
                        </tr>
                    @endforeach
                </tbody>
                @endif
