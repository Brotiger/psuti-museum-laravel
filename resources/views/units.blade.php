            ...
            <div class="my-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" maxlength="191" class="form-control" id="fullUnitName" placeholder="Полное название подразделения" data-field form-field autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="191" class="form-control" id="shortUnitName" placeholder="Сокращенное название подразделения" data-field form-field autocomplete="off">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="typeUnit" class="col-sm-3 col-form-label">Тип подразделения</label>
                    <div class="col-sm-9">
                        <input type="text" maxlength="191" class="form-control" id="typeUnit" placeholder="Тип подразделения" data-field form-field autocomplete="off">
                    </div>
                </div>
