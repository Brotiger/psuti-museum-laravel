<x-app-layout>
    <div class="container">
        <div class="alert alert-success" style="display: none" role="alert" id="success-message">Информация о подразделении успешно обновлена.<i class="bi bi-x-circle" close></i></div>
